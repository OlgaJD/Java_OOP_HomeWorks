...
public class View {
    ...
    public static void view() {
        ...
        System.out.print("|    ");
        System.out.print(Main.whiteTeam.get(0));
        tabSetter(Main.whiteTeam.get(0).toString().length(), l[0]);
        ...
        for (int i = 2; i < 9; i++) {
            ...
            System.out.print("|    ");
            System.out.print(Main.whiteTeam.get(i-1));
            tabSetter(Main.whiteTeam.get(i-1).toString().length(), l[0]);
            System.out.println(Main.blackTeam.get(i-1));
            System.out.println(midl10);
        }
        for (int j = 1; j < 11; j++) {
        ...
        System.out.print("|    ");
        System.out.print(Main.whiteTeam.get(9));
